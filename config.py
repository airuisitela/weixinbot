...
available_setting = {
    # openai api配置
    "open_ai_api_key": "key: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",  
    # openai api key
    # openai apibase，当use_azure_chatgpt为true时，需要设置对应的api base
    "open_ai_api_base": "https://api.openai.com/v1",
    "proxy": "1.1.1.1",  # openai使用的代理
    # chatgpt模型， 当use_azure_chatgpt为true时，其名称为Azure上model deployment名称
    "model": "gpt-3.5-turbo",    # 还支持 gpt-3.5-turbo-16k, gpt-4, wenxin
    "use_azure_chatgpt": False,  # 是否使用azure的chatgpt
    "azure_deployment_id": "we",  # azure 模型部署名称
    "azure_api_version": "we",  # azure api版本
    # Bot触发配置
    "single_chat_prefix": ["", "bot", "@bot",],  # 私聊时文本需要包含该前缀才能触发机器人回复
    "single_chat_reply_prefix": "[艾拉] ",  # 私聊时自动回复的前缀，用于区分真人
    ...
    "group_name_white_list": ["测试群", "ChatGPT测试群2"],  # 开启自动回复的群名称列表
